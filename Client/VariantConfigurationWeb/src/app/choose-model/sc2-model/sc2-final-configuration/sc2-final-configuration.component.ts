...
import {
  DetailsFinalModel
} from '../../../models/details-final.model';
import {
  AccessoriesFinalModel
} from '../../../models/accessories-final.model';
import {
  Host
} from '../../../helpers/host.helper';

@Component({
  selector: 'app-sc2-final-configuration',
  templateUrl: './sc2-final-configuration.component.html',
  styleUrls: ['../../../styles/final-configuration.css', '../../../styles/bike.css']
})
export class Sc2FinalConfigurationComponent extends Host implements OnInit, DoCheck {
