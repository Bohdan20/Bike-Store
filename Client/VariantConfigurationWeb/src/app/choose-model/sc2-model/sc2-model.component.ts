...
@Component({
  selector: 'app-sc2-model',
  templateUrl: './sc2-model.component.html',
  styleUrls: ['../../styles/details.css', '../../styles/bike.css']
})
export class Sc2ModelComponent extends Host implements OnInit {
  modelType = 'SC2';
  ...
  constructor(private router: Router, private detailsService: DetailsService, private accessoriesService: AccessoriesService) {
    super();
  }
  ...
  ngOnInit() {
    ...
    this.isMediaShelf = this.accessoriesService.getIsMediaShelfChoosen();
  }
  ...
  getDetails() {
    this.detailsService.getDetails().subscribe(data => {
      ...
      this.bikePrice = data.BasePriceSC2;
  ...
  setInitialBikePrice() {
    for (const prop in this.details) {
      for (let i = 0; i < this.details[prop].length; i++) {
        if (this.details[prop][i].DefaultSC2 === true) {
  ...
  setInitialPaintColorId() {
    for (let i = 0; i < this.details.PaintColors.length; i++) {
      if (this.details.PaintColors[i].DefaultSC2 === true) {
  ...
  setInitialFrameForkId() {
    for (let i = 0; i < this.details.ArtworkFrameForks.length; i++) {
      if (this.details.ArtworkFrameForks[i].DefaultSC2 === true) {
  ...
  setInitialBeltGuardId() {
    for (let i = 0; i < this.details.ArtworkBeltGuards.length; i++) {
      if (this.details.ArtworkBeltGuards[i].DefaultSC2 === true) {
  ...
  setInitialFlywheelId() {
    for (let i = 0; i < this.details.ArtworkFlywheels.length; i++) {
      if (this.details.ArtworkFlywheels[i].DefaultSC2 === true) {
  ...
  setInitialPlasticColorId() {
    for (let i = 0; i < this.details.PlasticsColors.length; i++) {
      if (this.details.PlasticsColors[i].DefaultSC2 === true) {
  ...
  setInitialSeatTypeId() {
    for (let i = 0; i < this.details.Seats.length; i++) {
      if (this.details.Seats[i].DefaultSC2 === true) {
  ...
  setInitialHandlebarTypePrice() {
    for (let i = 0; i < this.details.Handlebars.length; i++) {
      if (this.details.Handlebars[i].DefaultSC2 === true) {
  ...
  setInitialPedalTypePrice() {
    for (let i = 0; i < this.details.Pedals.length; i++) {
      if (this.details.Pedals[i].DefaultSC2 === true) {
  ...
  setInititalPowerMeterPrice() {
    for (let i = 0; i < this.details.PowerMeters.length; i++) {
      if (this.details.PowerMeters[i].DefaultSC2 === true) {
  ...
  setInititalConsoleTypeId() {
    for (let i = 0; i < this.details.Consoles.length; i++) {
      if (this.details.Consoles[i].DefaultSC2 === true) {
  ...
  setInititalSprintShiftTypeId() {
    for (let i = 0; i < this.details.SprintShifts.length; i++) {
      if (this.details.SprintShifts[i].DefaultSC2 === true) {
  ...
  proceedToAccessories() {
    ...
    this.router.navigate(['/sc2-accessories']);
  }
  ...
  choosePlasticColor(id) {
    ...
    for (let i = 0; i < this.details.PlasticsColors.length; i++) {
      this.details.PlasticsColors[i].DefaultSC2 = false;
      if (this.plasticColorTypeId === this.details.PlasticsColors[i].Id) {
        this.details.PlasticsColors[i].DefaultSC2 = true;
      }
    }
  ...
  chooseSeatType(id) {
    ...
    if (this.seatTypeId) {
      this.details.Seats[0].DefaultSC2 = true;
      this.bikePrice += this.details.Seats[0].BasePrice;
    } else {
      this.details.Seats[0].DefaultSC2 = false;
      this.bikePrice -= this.details.Seats[0].BasePrice;
    }
  }
  ...
  chooseConsoleType(id) {
    ...
    if (this.consoleTypeId) {
      this.details.Consoles[0].DefaultSC2 = true;
      this.bikePrice += this.details.Consoles[0].BasePrice;
      this.isConsoleChoosen = true;
    } else {
      this.details.Consoles[0].DefaultSC2 = false;
      this.bikePrice -= this.details.Consoles[0].BasePrice;
      this.isConsoleChoosen = true;
    }
  }
  ...
  chooseSprintShiftType(id) {
    ...
    if (this.sprintShiftTypeId === 1) {
      this.details.SprintShifts[0].DefaultSC2 = true;
      this.bikePrice += this.details.SprintShifts[0].BasePrice;
    } else {
      this.details.SprintShifts[0].DefaultSC2 = false;
      this.bikePrice -= this.details.SprintShifts[0].BasePrice;
    }
  }
  ...
  declinePedalType() {
    this.isPedalTypeChoosen = !this.isPedalTypeChoosen;
    for (let i = 0; i < this.details.Pedals.length; i++) {
      this.details.Pedals[i].DefaultSC2 = false;
    }
    if (this.pedalTypeId) {
  ...
  declineFlywheelType() {
    this.isFlywheelChoosen = !this.isFlywheelChoosen;
    this.details.ArtworkFlywheels[0].DefaultSC2 = false;
  ...
  selectStandartFrameFork(id, index) {
    ...
    for (let i = 0; i < this.details.ArtworkFrameForks.length; i++) {
      this.details.ArtworkFrameForks[i].DefaultSC2 = false;
    }
    this.details.ArtworkFrameForks[index].DefaultSC2 = true;
    this.isCustomFrameForkSelected = false;
  ...
  selectStandartBeltGuard(id, index) {
    ...
    for (let i = 0; i < this.details.ArtworkBeltGuards.length; i++) {
      this.details.ArtworkBeltGuards[i].DefaultSC2 = false;
    }
    this.details.ArtworkBeltGuards[index].DefaultSC2 = true;
    this.isCustomBeltGuardSelected = false;
  ...
  selectStandartFlywheel(id, index) {
    ...
    for (let i = 0; i < this.details.ArtworkFlywheels.length; i++) {
      this.details.ArtworkFlywheels[i].DefaultSC2 = false;
    }
    this.details.ArtworkFlywheels[index].DefaultSC2 = true;
    this.isCustomFlywheelSelected = false;
  ...
  selectHandlebarType(id, price, index) {
    ...
    for (let i = 0; i < this.details.Handlebars.length; i++) {
      this.details.Handlebars[i].DefaultSC2 = false;
    }
    this.details.Handlebars[index].DefaultSC2 = true;
  ...
  selectPedalType(id, price, index) {
    ...
    this.details.Pedals[index].DefaultSC2 = true;
    this.bikePrice -= this.previousPedalPrice;
    this.bikePrice += price;
  ...
  selectPowerMeterType(id, price, index) {
    ...
    for (let i = 0; i < this.details.PowerMeters.length; i++) {
      this.details.PowerMeters[i].DefaultSC2 = false;
    }
    this.details.PowerMeters[index].DefaultSC2 = true;
