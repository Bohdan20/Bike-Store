...
@Component({
  selector: 'app-sc3-accessories',
  templateUrl: './sc3-accessories.component.html',
  styleUrls: ['../../../styles/accessories.css', '../../../styles/bike.css']
})
export class Sc3AccessoriesComponent extends Host implements OnInit, DoCheck {
  ...
  setChosenAccessoriesForFinalConfiguration() {
    this.finalAccessories = [
      ...
      {
        accessoryName: this.accesories.HandlebarPosts[0].Title,
        accessoryQuantity: this.accessoryQuantity.handlebarPostQuantity
      },
      {
  ...
  finalConfigurationSC3() {
    ...
    this.router.navigate(['/final-configuration-sc3']);
  }
